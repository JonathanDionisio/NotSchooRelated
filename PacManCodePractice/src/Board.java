...
public class Board extends JPanel implements ActionListener {
    ...
    private Image ii;
    private final Color dotColor = new Color(139,224,152,255);
    ...
    LinkedList FirstPlayername = new LinkedList<String>();
    LinkedList FirstPlayerScorename = new LinkedList<Integer>();

    // number of ghost/paclife/ghostspeed (EASY MEDI HARD)-------------

    static int BLOCK_SIZE = 24;
    static int N_BLOCKS = 15;
    static int SCREEN_SIZE = N_BLOCKS * BLOCK_SIZE;
    static int PAC_ANIM_DELAY = 2;
    static int PACMAN_ANIM_COUNT = 4;
    static int MAX_GHOSTS =15;
    ...
    public void PlayerName(Graphics2D g) {
        ...
        // s = "Player Name: " + FirstPlayername.getFirst().toString();
    ...
    //         public void run() {
    //           if(counter!=10){
    //             System.out.println(counter+"sseconds");
    //             counter++;
    //           }
    //           if(counter==10){
