...
public class level2 extends JPanel implements ActionListener {
    ...
    private final short levelData[] = {
        19, 26, 26, 26, 26, 26, 18, 18, 26, 26, 26, 26, 26, 26, 22,
        21, 19, 18, 18, 18, 26, 16, 20, 19, 26, 26, 26, 26, 22, 21,
        21, 25, 24, 28, 17, 22, 17, 20, 25, 26, 26, 26, 26, 20, 21,
        17, 18, 18, 18, 24, 28, 17, 16, 26, 26, 26, 26, 26, 20, 21,
        21, 17, 24, 16, 26, 26, 16, 20, 19, 26, 26, 26, 26, 20, 21,
        21, 21, 19, 16, 18, 22, 17, 16, 16, 26, 26, 26, 26, 24, 20,
        21, 21, 25, 24, 24, 28, 17, 20, 25, 26, 26, 26, 26, 22, 21,
        17, 16, 18, 18, 18, 18, 16, 16, 18, 18, 18, 18, 18, 16, 20,
        17, 24, 24, 24, 16, 24, 16, 16, 24, 24, 24, 16, 24, 24, 20,
        21, 19, 18, 18, 16, 22, 17, 20, 19, 18, 22, 17, 18, 22, 21,
        21, 25, 24, 28, 17, 16, 16, 20, 25, 16, 16, 16, 16, 20, 21,
        17, 26, 26, 26, 16, 28, 17, 16, 26, 24, 16, 16, 24, 16, 20,
        21, 19, 18, 22, 17, 18, 16, 20, 19, 22, 17, 20, 19, 20, 21,
        21, 25, 24, 24, 24, 24, 16, 20, 25, 24, 24, 24, 24, 28, 21,
        25, 26, 26, 26, 26, 26, 24, 24, 26, 26, 26, 26, 26, 26, 28
    };
    ...
    level2(int level2){
            this.level2score = level2;
    }

    public void drawScore(Graphics2D g) {

        Board score2plus = new Board();
        score2plus.score = level2score;
        int i;
        String s;

        // score2 + level2score = tae
        g.setFont(new Font("Monospaced", Font.BOLD, 10));
        g.setColor(new Color(96, 128, 255));
        s = "Score: " + score2 + level2score;
        g.drawString(s, SCREEN_SIZE / 2 + 65, SCREEN_SIZE + 16);
    ...
    private void Level(Graphics2D g) {
        ...
        g.setColor(new Color(96, 128, 255));
        s = "|LEVEL2|";
        g.drawString(s, SCREEN_SIZE / 2 + 130, SCREEN_SIZE + 16);
